-- ==========================================
-- MENU VIP PRO V38 (Sắp xếp lại Tab Nhân Vật)
-- ==========================================
...
-- 2. Khóa vị trí (Hình ảnh image_1.png) - OFF
createToggle(page1, "🔒 Khóa vị trí (Đóng băng)", false, function(v) State.LockPosition = v end)

-- 3. Chống ngã (Xuống dưới thanh chạy nhanh)
createToggle(page1, "🛡️ Chống ngã & Chống văng xa", false, function(v) State.AntiStun = v end)

-- Các tính năng khác giữ nguyên thứ tự
